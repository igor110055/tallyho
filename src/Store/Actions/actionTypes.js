export const SIGN_UP = "[Auth Action] sign up user";

// token actions
export const TOKEN_FOUND_BY_ADDRESS = "token found by address";

// setting actions
export const TRANSACTION_SPEED_SET = "set the transaction speed in GWEI";

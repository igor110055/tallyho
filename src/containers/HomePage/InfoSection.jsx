...
const InfoSection = () => {
    return (
        <div className='mx-4 mb-14 grid max-w-5xl grid-cols-2 gap-2 rounded-2xl bg-info_gradient p-6 sm:container sm:mx-auto sm:max-w-7xl md:grid-cols-3 md:gap-8'>

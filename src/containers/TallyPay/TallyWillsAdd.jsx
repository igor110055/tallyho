    ...
    const handleApprove = async () => {
        ...
        if (!SelectBNB) {
            asset.methods
                .approve(
                    conAddress,
                    web3.utils.toWei(_totalAmount.toString(), 'ether')
                )
                .send({ from: address });
            tally.methods
                .approve(
                    conAddress,
                    web3.utils.toWei(SPBNB[3].toString(), 'ether')
                )
                .send({ from: address });
        } else {
            asset.methods
            ...
            <div className='mt-6 grid w-full grid-cols-1 gap-y-4 md:grid-cols-2'>
                <div className='flex max-w-fit flex-col'>
                    <div className='flex items-center space-x-2 text-white'>
                        ...
                        <span>
                            Tally{' '}
                            {`${(balance / 1000000000000000000).toFixed(0)}`}
                        </span>
                    </div>
                    <span className='self-end text-tallyPay-primaryText'>
                        {((balance / 1000000000000000000) * TallyPrice).toFixed(
                            5
                        )}{' '}
                        USD
                    </span>
                ...
                <div className=' flex max-w-fit flex-col'>
                    <div className='flex items-center space-x-2 text-white'>
                        ...
                        <span>
                            BNB{' '}
                            {`${(ethBalance / 1000000000000000000).toFixed(2)}`}
                        </span>
                    </div>
                    <span className='self-end text-tallyPay-primaryText'>
                        {(
